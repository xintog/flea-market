...
<script>
//绑定input change事件
$("#user-avatar-upload").unbind("change").on("change",function(){
...
function putb64(pic){
	...
	xhr.onreadystatechange=function(){
		if (xhr.readyState==4){
            ...
            var tmp = '\
                <img src="<?= img_url() ?>' + filename + '?imageView2/1/w/250/h/250" style="width: 100%; height: 100%">\
                <input type="hidden" name="avatar" value="' + filename + '">';
            document.getElementById('user-avatar-preview').innerHTML = tmp;
