<?php $this->load->view('layout/header', ['title' => '我的收藏']) ?>
            ...
            <table class="table table-hover" style="table-layout: fixed;">
                <thead>
                    <tr>
                        ...
                        <th class="col-lg-2 col-md-2 col-sm-2 hidden-xs">收藏时间</th>
                        ...
                        <th class="col-lg-1 col-md-1 col-sm-2 col-xs-3">收藏操作</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if( ! $collects_num) : ?>
                    ...
                    <tr>
                        ...
                        <td class="hidden-xs">
                            <span class="hidden-sm"><?= $p->collect_created ?></span>
                            <span class="visible-sm-inline"><?= date('m月d日H:i', strtotime($p->collect_created)) ?></span>
                        </td>
                        ...
                        <td>
                            <?php if($p->state == 0) : ?>
                            <a class="btn btn-success btn-xs" href="<?= site_url('order/create/' . $p->pid) ?>">点击订购</a>
                            <?php elseif($p->state == 1) : ?>
                            <a class="btn btn-warning btn-xs">已经出售</a>
                            <?php endif; ?>
                        </td>
                        <td>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="<?= site_url('user/delcollect/' . $p->pid) ?>" class="btn btn-primary">删除</a>
                                </div>
                            </div>
                        </div>
                    </div>
