<input id="admin-imgshead-upload" type="file" accept="image/*" capture="camera" data-url="upload" class="hidden" multiple>
<canvas id="cvs" width="0" height="0" class="hidden"></canvas>
<script>
//绑定input change事件
$("#admin-imgshead-upload").unbind("change").on("change",function(){
...
<div class="media alert alert-success" style="text-align: center;">\
    <img src="<?= img_url() ?>' + filename + '" alt="上传成功" style="width: 96%">\
	...
	<input type="hidden" name="imgs[]" value="' + filename + '">\
</div>';
            $('<div class="col-lg-6 col-md-4 col-sm-4 col-xs-6" id="' + divid + '"/>').text('').appendTo(document.getElementById('admin-imgshead-preview'));
